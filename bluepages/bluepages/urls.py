...
class ContactSitemap(Sitemap):
    ...
    def items(self):
        return [contact for contact in Contact.objects.filter(is_test_data=False) if contact.public]
...
urlpatterns = [
    ...
    path('sitemap.xml', sitemap, {'sitemaps': {'contact': ContactSitemap}}, name='django.contrib.sitemaps.views.sitemap'),
