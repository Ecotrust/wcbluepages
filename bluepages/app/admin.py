...
def get_entity_hierarchy_alias(prefix="entity__"):
    return Concat(
        f"{prefix}name",
        Value(" "),
        f"{prefix}parent__name",
        Value(" "),
        f"{prefix}parent__parent__name",
        Value(" "),
        f"{prefix}parent__parent__parent__name",
        Value(" "),
        f"{prefix}parent__parent__parent__parent__name",
        Value(" "),
        f"{prefix}parent__parent__parent__parent__parent__name",
        Value(" "),
        f"{prefix}parent__parent__parent__parent__parent__parent__name",
        Value(" "),
        f"{prefix}parent__parent__parent__parent__parent__parent__parent__name",
        Value(" "),
        f"{prefix}parent__parent__parent__parent__parent__parent__parent__parent__name",
        Value(" "),
        f"{prefix}parent__parent__parent__parent__parent__parent__parent__parent__parent__name",
        Value(" "),
        f"{prefix}parent__parent__parent__parent__parent__parent__parent__parent__parent__parent__name",
        Value(" "),
    )
...
class RecordForm(forms.ModelForm):
    class Meta:
        model = Record
        widgets = {"regions": admin.widgets.FilteredSelectMultiple("Region", False)}
        fields = "__all__"
...
class ContactAdmin(VersionAdmin):
    ...
    fieldsets = (
        ...
        ("Position", {"fields": (("entity", "job_title", "expertise"),)}),
        (
            "Contact Information",
            {
                "fields": (
    ...
    def get_queryset(self, request):
        qs = super().get_queryset(request)
        qs = qs.alias(entity_hierarchy=get_entity_hierarchy_alias("entity__"))
        return qs
...
class ContactSuggestionAdmin(VersionAdmin):
    ...
    inlines = [RecordSuggestionInline]
...
class RecordSuggestionAdmin(VersionAdmin):
    ...
    search_fields = (
        ...
        "user",
        "topic__name",
        "contact_suggestion__last_name",
        "contact_suggestion__first_name",
        "contact_suggestion__email",
        "entity_hierarchy",
    )
    form = RecordSuggestionForm
    ...
    def get_queryset(self, request):
        ...
        qs = qs.alias(
            entity_hierarchy=get_entity_hierarchy_alias(
                prefix="contact_suggestion__entity__"
            )
        )
        return qs
