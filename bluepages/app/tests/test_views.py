...
class GetSuggestionMenuTestCase(TestCase):
    ...
    def test_getSuggestionMenu_with_pending_suggestions(self):
        ...
        self.assertEqual(response.context['suggestions'][0]['contact_name'], 'new (Doe, John)')
...
class deleteRecordTestCase(TestCase):
    ...
    def test_deleteRecord_unauthenticated(self):
        ...
        response = self.client.post(reverse('delete_record', args=[self.contact.id, self.record.id]))
        self.assertEqual(response.status_code, 302)
...
class contactFormTestCase(TestCase):
    ...
    def test_contactForm_post_request_valid_data(self):
        ...
        self.client.login(username='testuser', password='testpass123')
        response = self.client.post(reverse('contact_form', args=[self.contact.id]), {
            'first_name': 'John',
            'last_name': 'Doee',
...
class contactSuggestionFormTestCase(TestCase):
    ...
    def test_contactSuggestionForm_unauthenticated(self):
        ...
        response = self.client.get(reverse('contact_suggestion_form', args=[self.contact_suggestion.id]))
        self.assertEqual(response.status_code, 302)
    ...
    def test_contactSuggestionForm_post_request_valid_data(self):
        ...
        self.client.login(username='testuser', password='testpass123')
        response = self.client.post(reverse('contact_suggestion_form', args=[self.contact_suggestion.id]), {
            'user': self.user.id,
            'status': 'Pending',
            'first_name': 'John',
            'last_name': 'Doee',
...
class recordContactFormTestCase(TestCase):
    ...
    def test_recordContactForm_unauthenticated(self):
        ...
        response = self.client.get(reverse('record_contact_form', args=[self.contact.id, self.record.id]))
        self.assertEqual(response.status_code, 302)
    ...
    def test_recordContactForm_post_request_valid_data(self):
        ...
        self.client.login(username='testuser', password='testpass123')
        response = self.client.post(reverse('record_contact_form', args=[self.contact.id, self.record.id]), {
